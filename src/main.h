...
static const int64 MIN_TX_FEE = 10000;//min fee 0.00001 cmc
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 200000000 * COIN; // Cosmoscoin: maximum of 200 million coins
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY = 10;//mining need 30 confirmation
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // Cosmoscoin: 2880 blocks found a day. Priority cutoff is 1 Cosmoscoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0401888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888")))
