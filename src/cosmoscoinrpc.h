...
#ifndef _COSMOSCOINRPC_H_
#define _COSMOSCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Cosmoscoin is not connected
...
/**
 * Cosmoscoin RPC command dispatcher.
 */
class CRPCTable
{
private:
