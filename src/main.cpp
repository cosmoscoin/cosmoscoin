...
uint256 hashGenesisBlock("0xbf029afac04e0f8711d629445895227fced5d290e4ee697625173d88af8c8041");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Cosmoscoin: starting difficulty is 1 / 2^12
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Cosmoscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbf029afac04e0f8711d629445895227fced5d290e4ee697625173d88af8c8041");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Cosmoscoin, the coin rule the whole cosmos! - June 26, 2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x09e2dc1d17bc219062b7d504fc7f2714d38b7e7f762e35d34cd0b73809fa35de"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Cosmoscoind: Reduce the exempted free transactions to 500 bytes (from Cosmoscoin's 3000 bytes)
...
void static CosmoscoinMiner(CWallet *pwallet)
{
    printf("CosmoscoinMiner started\n");
    ...
    while (fGenerateCosmoscoins)
    {
        ...
        printf("Running CosmoscoinMiner with %d transactions in block\n", pblock->vtx.size());
...
void GenerateCosmoscoins(bool fGenerate, CWallet* pwallet)
{
    ...
    if (fGenerate)
    {
        ...
        {
            if (!CreateThread(ThreadCosmoscoinMiner, pwallet))
                printf("Error: CreateThread(ThreadCosmoscoinMiner) failed\n");
            Sleep(10);
        }
    }
}
